...
class MusicController:
    ...
    def stateLeft(self, state, event):
        ...
        if state >=1 and state <=8:
            ...
            self._buzzer.stop()
            time.sleep(5)
            self._display.showText("Goodbye Music.")
            self._lights.off()
        # etc.